$(document).ready(function(){
    ...
    //Animate square using left, opacity, height properties
     $("#square").click(function(){
        $("#square").animate({left: '800px', opacity:0.25,height:"toggle", width:'60px'}, 1000);
    }) 
    //Animate to bigger size
    $("#square").click(function(){
        $("#square").animate({left: '800px', opacity:0.25,height:"+=200px", width:"+=200px"}, 1000);
    }) 

    //Queue functionality
    $("#square").click(function(){
        $("#square").animate({left: '400px', opacity:0.25}, 1000);
        $("#square").animate({left: '600px', opacity:0.25}, 1000);
        $("#square").animate({left: '800px', opacity:0.25}, 1000);
    }); 

    //Stop the animation
    $("#square").click(function(){
        $("#square").animate({left: '1500px', opacity:0.25}, 5000);
    });
    $(".stop").click(function(){
        $("#square").stop();
